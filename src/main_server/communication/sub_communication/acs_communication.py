...
# ACS 통신
class AcsCommunication(TcpSocketFrame):
    ...
    def received_data_process(self, data_dict: dict):
        ...
        if send_type != 'ACS' or number != self.hmi_number:
            ...
            #     if data_type == 'hmi_status':
            #         # HMI 상태 정보
            #         self.received_hmi_status(data_info)
            #     elif data_type == 'work_unsatisfied':
            #         # 작업 조건 불충족
            #         self.received_work_unsatisfied(data_info)
            #     elif data_type == 'call_response':
            #         # 호출 응답 데이터
            #         self.received_call_response(data_info)
            #     elif data_type == 'manual_response':
            #         # 수동 명령 응답 데이터
            #         self.received_manual_response(data_info)
